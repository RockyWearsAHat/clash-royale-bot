...
// Resets an unlinked member’s roles so they only keep @everyone (no clan/vanquished access).
export async function enforceUnlinkedMemberRoleReset(ctx: AppContext, member: GuildMember) {
